...
mod = 'release_iccv/mrdalne_1000_baseline_lite'
...
transformer=dict(
    type='MRDALaneTransformer',
    decoder=dict(
        type='MRDALaneTransformerDecoder',
        embed_dims=_dim_,
        num_layers=2,
...
sparse_ins_decoder=Config(
    dict(
        encoder=dict(
            out_dims=_dim_),
        decoder=dict(
            num_query=mrdalane_cfg['num_query'],
            num_group=mrdalane_cfg['num_group'],
            sparse_num_group=mrdalane_cfg['sparse_num_group'],
            hidden_dim=_dim_,
            kernel_dim=_dim_,
