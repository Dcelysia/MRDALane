...
class MRDALaneDecoderLayer(BaseTransformerLayer):
    def __init__(self,
                 attn_cfgs,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(MRDALaneDecoderLayer, self).__init__(
            attn_cfgs=attn_cfgs,
...
class MRDALaneTransformerDecoder(TransformerLayerSequence):
    def __init__(self,
                 *args, embed_dims=None,
                 ...
                 anchor_y_steps=None,
                 **kwargs):
        super(MRDALaneTransformerDecoder, self).__init__(*args, **kwargs)
...
class MRDALaneTransformer(BaseModule):
    def __init__(self, encoder=None, decoder=None, init_cfg=None):
        super(MRDALaneTransformer, self).__init__(init_cfg=init_cfg)
